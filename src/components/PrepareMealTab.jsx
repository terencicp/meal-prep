      ...
      {hasMealItems && (
        <div className='mt-6 flex justify-center'>
          <button
            ...
            className={`w-56 sm:w-64 px-5 py-3 sm:py-3 border-4 border-black text-sm sm:text-sm font-black uppercase tracking-wide transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-1 active:translate-y-1 active:shadow-none ${
              isSubstitutionMode
