...
The `Food groups` button at the bottom of the `Meals` tab opens a modal where you can:
...
Start in the `Meals` tab by setting your daily calorie goal, which helps you quickly see whether your planned meals are close to your goal.
